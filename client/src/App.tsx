...
const App: FC = (props: Props) => {
    ...
    const handleFileUpload = async (e: MouseEvent<HTMLButtonElement>) => {
        ...
        setLoading(true);
        try {
            // Note: Please update the endpoint with the backend server incase if you are deploying on the different instance.
            const url = `http://127.0.0.1:3000/api/logs/logParser/${modifiedFileName}`;
